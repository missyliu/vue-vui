...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "_v-649dcfb4/Suggest.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coerceBoolean = __webpack_require__(8);
	...
	exports.default = {
	  ...
	  methods: {
	    update: function update() {
	      ...
	      if (this.ajaxUrl) {
	        (0, _ajax2.default)(this.ajaxUrl + this.query, function (data) {
